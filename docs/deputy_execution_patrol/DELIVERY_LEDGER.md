...
| Raw Candidate | Issue #17 / PR #26 | Raw Candidate Builder | `warehouse/raw-source-quality-scoring` | `7853fe7` | `https://github.com/laibeoffer/laibe-mvp/pull/26` | `FINAL_GATE_READY` | PR #26 merge ref exists; Executive validation and candidate-only / forbidden-pricing checks recorded in comment `4531540239`; Codex clean result `4531555287`; Executive routed to Deputy gate in comment `4531573641`. | Validation passed; candidate-only safety and forbidden formal-pricing negatives reported clean. | 0 | Deputy Codex | Deputy final merge / reject gate. No Executive chase unless branch state changes. | MEDIUM | No | No unless branch changes, scope drift, formal price risk, or Codex review reports NEEDS_FIX / P1 / P2 |
...
| Output Documents | Issue #18 / PR #23 | Output Documents Builder | `output/renderer-static-guard-review-packet` | `a75e380` | `https://github.com/laibeoffer/laibe-mvp/pull/23` | `FINAL_GATE_READY` | PR #23 post-resync merge ref exists; checks reported in comment `4531552098`; Codex post-resync clean result `4531569296`; Executive routed to Deputy gate in comment `4531573705`. | Renderer static guard, syntax, mismatch, fixture, invalid fixture, and no `.xlsx` / `.pdf` diff checks reported clean after latest-main resync. | 0 | Deputy Codex | Deputy final merge / reject gate. No Executive chase unless branch state changes. | MEDIUM | No | No unless branch changes, scope drift, or Codex review reports NEEDS_FIX / P1 / P2 |

...
| Evidence status transition log | `docs/ai_pcm/contract_evidence_admin/evidence_status_transition_log.md` | `linked` | Records allowed status transitions without creating verified project evidence. |

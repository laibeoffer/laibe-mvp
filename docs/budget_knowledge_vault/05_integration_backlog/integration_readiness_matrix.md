...
- checked_at: 2026-06-01T14:58:06+08:00
...
- assigned_pr_head_sha_at_patrol_start: `76d7559801287ead57184c227a34455ea730efe5`
...
- scoped_change_since_last_patrol: PR #32 still has no comments or review threads and GitHub reports it mergeable at patrol-start head `76d7559801287ead57184c227a34455ea730efe5`; PR #31 has no new disposition comments or review threads; Issue #41 adds PR #37 docs-only final-report status; Issue #49 records Commander authorization for `budget/engine-entry-picking` to prepare the minimal dry-run runtime with zero-value placeholders only; compact blackboard support-only boundaries are unchanged.

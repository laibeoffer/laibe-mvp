...
export const PCM_FLOW_NODES = Object.freeze([
  ...
  freezeRecord({ id: "drawingCheck", publicPath: "/pcm/drawing-check", label: "文件健檢舊入口", role: "甲方", owner: "A0", lifecycle: "compatibility_redirect", gate: "G1_UI_SOURCE", href: "../quote_check/code.html?mode=contract#document-workspace", redirectTo: "/pcm/quote-check/?mode=contract#document-workspace" }),
...
export const PCM_FLOW_CANONICAL_LINKS = Object.freeze([
  ...
  freezeRecord({
    ...
    expectedVisibleState: "文件健檢工作台載入，甲方可在報價、圖說與契約分頁切換。",
    returnRoute: "home",
    routeState: "active",
  }),
  freezeRecord({
    ...
    relativeHref: "../quote_check/code.html?mode=contract#document-workspace",
    canonicalHttpUrl: "/pcm/quote-check/?mode=contract#document-workspace",
    expectedVisibleState: "文件健檢工作台載入，甲方可在同一頁查看圖說檢查狀態與下一步。",
    returnRoute: "home",
    routeState: "active",
  }),
  freezeRecord({
...
export const PCM_FLOW_EDGES = Object.freeze([
  ...
  freezeRecord({ from: "home", to: "quoteCheck", kind: "forward", gate: "G1_UI_SOURCE", owner: "A0", action: "前往圖說檢查", clickable: true }),
...
export const PCM_FLOW_FAILURE_MATRIX = Object.freeze({
  ...
  QUOTE_ONLY_DRAWING_MISSING: closedState({ code: "QUOTE_ONLY_DRAWING_MISSING", reason: "目前只有報價文件，尚未有可供核對的施工圖。", nextAction: "取得至少包含平面圖的施工圖 PDF，再回到文件健檢工作台。", responsibleRole: "甲方", returnRoute: "quoteCheck", recoveryRoute: "quoteCheck", payloadPolicy: "SUBMISSION_REFERENCE_ONLY" }),
  DRAWING_ONLY_QUOTE_MISSING: closedState({ code: "DRAWING_ONLY_QUOTE_MISSING", reason: "目前只有施工圖，尚未有可供核對的報價文件。", nextAction: "取得乙方報價 PDF，再回到文件健檢工作台。", responsibleRole: "甲方", returnRoute: "quoteCheck", recoveryRoute: "quoteCheck", payloadPolicy: "SUBMISSION_REFERENCE_ONLY" }),
  ...
  FILE_UNREADABLE: closedState({ code: "FILE_UNREADABLE", reason: "文件內容過於模糊，目前無法可靠辨識。", nextAction: "取得清楚版本或重新掃描，再回到文件健檢工作台。", responsibleRole: "文件提交者", returnRoute: "home", recoveryRoute: "quoteCheck", payloadPolicy: "FILE_METADATA_ONLY" }),

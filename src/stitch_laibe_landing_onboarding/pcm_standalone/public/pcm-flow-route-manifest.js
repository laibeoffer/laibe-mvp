...
export const PCM_FLOW_NODES = Object.freeze([
  ...
  freezeRecord({
    ...
    lifecycle: "active",
    gate: "G1_UI_SOURCE",
    href: "../public_home/code.html#top",
  }),
  freezeRecord({
    id: "aboutDrs",
  ...
  freezeRecord({
    ...
    redirectTo: "/pcm/quote-check/?mode=contract#document-workspace",
  }),
  freezeRecord({
    id: "accountAccess",
  ...
  freezeRecord({
    id: "caseSetup",
    publicPath: "/pcm/case/setup",
    label: "案件建立與正式 PCM 申請",
    role: "甲方",
    owner: "A0",
    lifecycle: "planned",
    gate: "G2_AUTH_RUNTIME",
    href: null,
  }),
  freezeRecord({
    id: "serviceContract",
    publicPath: "/pcm/service-contract",
    label: "PCM 服務契約",
    role: "甲方與受邀乙方",
    owner: "A0",
    lifecycle: "active",
  ...
  freezeRecord({
    id: "contractPrerequisites",
    publicPath: "/pcm/contract/prerequisites",
    label: "契約待補項目",
    role: "甲方與受邀乙方",
    owner: "A0",
    lifecycle: "active",
    gate: "G1_UI_SOURCE",
    href: "../contract_prerequisites/code.html",
  }),
  freezeRecord({
    id: "contractSigning",
    publicPath: "/pcm/contract/sign",
    label: "PCM 契約簽訂",
    role: "甲方與受邀乙方",
    owner: "A0",
    lifecycle: "active",
    gate: "G1_UI_SOURCE",
    href: "../contract_signing/code.html",
  }),
  freezeRecord({
    id: "ownerWorkspace",
  ...
  freezeRecord({
    id: "vendorInvitation",
    publicPath: "/pcm/vendor/invitation",
    label: "乙方邀請與成員確認",
    role: "受邀乙方",
    owner: "A6",
    lifecycle: "planned",
  ...
  freezeRecord({
    id: "reviewerAccess",
    publicPath: "/pcm/reviewer/access",
    label: "DRS 審查員帳號入口",
    role: "DRS 審查員",
    owner: "A3",
    lifecycle: "active",
    gate: "G1_UI_SOURCE",
    href: "../../drs_standalone/reviewer_access/code.html",
  }),
  freezeRecord({
    id: "pcmAuthorizedList",
    publicPath: "/pcm/console",
    label: "DRS 案件審查入口",
    role: "DRS 專員",
    owner: "A6",
    lifecycle: "active",
    gate: "G2_AUTH_RUNTIME",
    href:
      "../../drs_standalone/specialist_workspace/code.html#governance-inbox",
  }),
  freezeRecord({
    id: "pcmCaseWorkspace",
    publicPath: "/pcm/console/case",
    label: "DRS 案件文件審查",
    role: "已授權 DRS 專員",
    owner: "A6",
    lifecycle: "active",
    gate: "G2_AUTH_RUNTIME",
    href:
      "../../drs_standalone/specialist_workspace/code.html#case-review-engineering",
  }),
  freezeRecord({
    id: "internalGovernance",
    publicPath: "/pcm/governance",
    label: "內部治理清單",
    role: "管理者",
    owner: "A6",
    lifecycle: "planned",
  ...
  freezeRecord({
    id: "caseRecordCenter",
    publicPath: "/pcm/case/records",
    label: "案件紀錄中心",
    role: "案件三方",
    owner: "A5",
    lifecycle: "planned",
    gate: "G3_DURABLE_DATA",
    href: null,
  }),
  freezeRecord({
    id: "caseCloseout",
    publicPath: "/pcm/case/closeout",
    label: "案件取消、結案與三方確認",
    role: "案件三方",
    owner: "A5",
    lifecycle: "planned",
  ...
  freezeRecord({
    id: "accessUnavailable",
    publicPath: "/pcm/access-unavailable",
    label: "安全恢復入口",
    role: "入口使用者",
    owner: "A0",
    lifecycle: "active",
    gate: "G1_UI_SOURCE",
    href: "../access_unavailable/code.html",
  }),
  freezeRecord({
    id: "legacyPcmRoot",
    publicPath: null,
...
export const PCM_FLOW_COMPATIBILITY_ALIASES = Object.freeze([
  freezeRecord({
    id: "ownerStart",
    lifecycle: "RETIRED_COMPATIBILITY",
    canonicalHref: null,
    compatibilityHref: "../owner_start/code.html",
    replacementRoute: "accountAccess",
  }),
  freezeRecord({
    id: "documentCorrections",
    lifecycle: "RETIRED_COMPATIBILITY",
    canonicalHref: null,
    compatibilityHref: "../document_corrections/code.html",
    replacementRoute: "quoteCheck",
  }),
  freezeRecord({
    id: "basicReport",
    lifecycle: "RETIRED_COMPATIBILITY",
    canonicalHref: null,
    compatibilityHref: "../basic_report/code.html",
    replacementRoute: "quoteCheck",
  }),
  freezeRecord({
    id: "selfServiceArchive",
    lifecycle: "RETIRED_COMPATIBILITY",
    canonicalHref: null,
    compatibilityHref: "../self_service_archive/code.html",
    replacementRoute: "ownerWorkspace",
  }),
]);
...
export const PCM_FLOW_CANONICAL_LINKS = Object.freeze([
  freezeRecord({
    ...
    expectedVisibleState:
      "帳號入口先說明甲方契約管理目的；正式身分與案件權限確認後才會開放相應工作台。",
    returnRoute: "home",
    routeState: "active",
  }),
  freezeRecord({
  ...
  freezeRecord({
    ...
    expectedVisibleState:
      "關於 DRS 頁載入，甲方可理解書面核對、決策責任與案件留痕的服務邊界。",
    returnRoute: "home",
    routeState: "active",
  }),
  freezeRecord({
  ...
  freezeRecord({
    ...
    canonicalHttpUrl: "/pcm/quote-check/?mode=contract#document-workspace",
    expectedVisibleState:
      "文件健檢工作台以契約健檢模式載入，顯示專案契約文件入口、目前狀態與下一步。",
    returnRoute: "home",
    routeState: "active",
  }),
  freezeRecord({
  ...
  freezeRecord({
    ...
    expectedVisibleState:
      "乙方案件工作台載入；身分與案件範圍未確認時維持零案件資料與安全空狀態。",
    returnRoute: "accountAccess",
    routeState: "active",
  }),
  freezeRecord({
  ...
  freezeRecord({
    ...
    expectedVisibleState:
      "可信甲方契約管理來源返回甲方工作台，並選取「契約管理」主分頁。",
    returnRoute: "serviceContract",
  ...
  freezeRecord({
    ...
    canonicalHttpUrl:
      "/pcm/service-contract?returnTo=owner-contract#full-contract",
    expectedVisibleState:
      "從甲方工作台契約管理進入 DRS 服務契約完整內容；服務契約頁可返回甲方契約管理。",
    returnRoute: "ownerWorkspace",
    routeState: "active",
  }),
  freezeRecord({
...
export const PCM_FLOW_EDGES = Object.freeze([
  ...
  freezeRecord({
    ...
    gate: "G2_AUTH_RUNTIME",
    owner: "A6",
    action: "申請正式 PCM 並閱讀契約",
    clickable: false,
  }),
  freezeRecord({
    from: "serviceContract",
    to: "contractPrerequisites",
    kind: "pending",
    gate: "G1_UI_SOURCE",
    owner: "A0",
    action: "補齊契約前提",
...
export const PCM_FLOW_FAILURE_MATRIX = Object.freeze({
  VENDOR_INVITATION_DECLINED: closedState({
    code: "VENDOR_INVITATION_DECLINED",
    reason: "乙方已婉拒本次案件邀請。",
    nextAction: "由甲方確認是否改邀其他乙方，或先保留目前案件。",
    responsibleRole: "甲方",
    returnRoute: "vendorInvitation",
    recoveryRoute: "accountAccess",
    payloadPolicy: "ZERO_CASE_DATA",
  }),
  VENDOR_INVITATION_EXPIRED: closedState({
    code: "VENDOR_INVITATION_EXPIRED",
    reason: "這份案件邀請已超過可使用期間。",
    nextAction: "請甲方重新確認合作對象並送出新邀請。",
    responsibleRole: "甲方",
    returnRoute: "vendorInvitation",
    recoveryRoute: "accountAccess",
    payloadPolicy: "ZERO_CASE_DATA",
  }),
  VENDOR_INVITATION_WITHDRAWN: closedState({
    code: "VENDOR_INVITATION_WITHDRAWN",
    reason: "甲方已收回這份案件邀請。",
    nextAction: "由甲方決定是否重新邀請，乙方目前不需處理。",
    responsibleRole: "甲方",
    returnRoute: "vendorInvitation",
    recoveryRoute: "accountAccess",
    payloadPolicy: "ZERO_CASE_DATA",
  }),
  VENDOR_INVITATION_RESEND_REQUIRED: closedState({
    code: "VENDOR_INVITATION_RESEND_REQUIRED",
    reason: "原邀請資料無法繼續使用，需要重新送出。",
    nextAction: "請甲方確認乙方資料後重新寄送案件邀請。",
    responsibleRole: "甲方",
    returnRoute: "vendorInvitation",
    recoveryRoute: "accountAccess",
    payloadPolicy: "ZERO_CASE_DATA",
  ...
  QUOTE_ONLY_DRAWING_MISSING: closedState({
    ...
    reason: "目前只有報價文件，尚未有可供核對的施工圖。",
    nextAction: "取得至少包含平面圖的施工圖 PDF，再回到文件健檢工作台。",
    responsibleRole: "甲方",
    returnRoute: "quoteCheck",
    recoveryRoute: "quoteCheck",
    payloadPolicy: "SUBMISSION_REFERENCE_ONLY",
  }),
  DRAWING_ONLY_QUOTE_MISSING: closedState({
    code: "DRAWING_ONLY_QUOTE_MISSING",
    reason: "目前只有施工圖，尚未有可供核對的報價文件。",
    nextAction: "取得乙方報價 PDF，再回到文件健檢工作台。",
    responsibleRole: "甲方",
    returnRoute: "quoteCheck",
    recoveryRoute: "quoteCheck",
    payloadPolicy: "SUBMISSION_REFERENCE_ONLY",
  }),
  FILE_FORMAT_INVALID: closedState({
    code: "FILE_FORMAT_INVALID",
    reason: "這份文件不是目前可檢查的 PDF 格式。",
    nextAction: "回到原檢查頁，重新選擇 PDF 文件。",
    responsibleRole: "文件提交者",
    returnRoute: "home",
    recoveryRoute: "quoteCheck",
    payloadPolicy: "FILE_METADATA_ONLY",
  }),
  FILE_TOO_LARGE: closedState({
    code: "FILE_TOO_LARGE",
    reason: "這份文件超過目前可接收的檔案大小。",
    nextAction: "壓縮或拆分文件後，再回到原檢查頁重新提交。",
    responsibleRole: "文件提交者",
    returnRoute: "home",
    recoveryRoute: "quoteCheck",
    payloadPolicy: "FILE_METADATA_ONLY",
  }),
  PAGE_COUNT_INVALID: closedState({
    code: "PAGE_COUNT_INVALID",
    reason: "這份文件的頁數不符合本次檢查範圍。",
    nextAction: "保留需要檢查的頁面後，再回到原檢查頁重新提交。",
    responsibleRole: "文件提交者",
    returnRoute: "home",
    recoveryRoute: "quoteCheck",
    payloadPolicy: "FILE_METADATA_ONLY",
  }),
  FILE_UNREADABLE: closedState({
    code: "FILE_UNREADABLE",
    reason: "文件內容過於模糊，目前無法可靠辨識。",
    nextAction: "取得清楚版本或重新掃描，再回到文件健檢工作台。",
    responsibleRole: "文件提交者",
    returnRoute: "home",
    recoveryRoute: "quoteCheck",
    payloadPolicy: "FILE_METADATA_ONLY",
  }),
  FILE_CORRUPTED: closedState({
    code: "FILE_CORRUPTED",
    reason: "文件內容不完整或無法正常開啟。",
    nextAction: "重新匯出 PDF，確認可開啟後再提交。",
    responsibleRole: "文件提交者",
    returnRoute: "home",
    recoveryRoute: "quoteCheck",
    payloadPolicy: "FILE_METADATA_ONLY",
  }),
  DUPLICATE_SUBMISSION: closedState({
    code: "DUPLICATE_SUBMISSION",
    reason: "相同版本已經提交，不需要重複送出。",
    nextAction: "確認要沿用既有版本，或改選更新後的文件。",
    responsibleRole: "文件提交者",
    returnRoute: "home",
    recoveryRoute: "quoteCheck",
    payloadPolicy: "SUBMISSION_REFERENCE_ONLY",
  ...
  VERSION_CONFLICT: closedState({
    ...
    reason: "目前選擇的文件版本與既有確認版本不一致。",
    nextAction: "先確認要採用的單一版本，再重新提交。",
    responsibleRole: "甲方",
    returnRoute: "home",
    recoveryRoute: "quoteCheck",
    payloadPolicy: "VERSION_REFERENCE_ONLY",
  }),
  CONTRACT_PREREQUISITES_MISSING: closedState({
    code: "CONTRACT_PREREQUISITES_MISSING",
    reason: "正式契約所需的身分或文件前提尚未齊備。",
    nextAction: "查看待補項目，依責任人逐項補齊。",
    responsibleRole: "待補項目責任人",
    returnRoute: "serviceContract",
    recoveryRoute: "contractPrerequisites",
    payloadPolicy: "CONTRACT_REFERENCE_ONLY",
  }),
  CONTRACT_VERSION_NOT_MUTUALLY_ACCEPTED: closedState({
    code: "CONTRACT_VERSION_NOT_MUTUALLY_ACCEPTED",
    reason: "甲乙雙方尚未確認同一份契約版本。",
    nextAction: "返回契約頁確認版本，完成雙方一致確認後再繼續。",
    responsibleRole: "甲方與乙方",
    returnRoute: "contractSigning",
    recoveryRoute: "serviceContract",
    payloadPolicy: "CONTRACT_REFERENCE_ONLY",
  }),
  IDENTITY_UNCONFIRMED: closedState({
    code: "IDENTITY_UNCONFIRMED",
    reason: "目前無法確認使用者身分。",
    nextAction: "回到共用註冊與登入入口，完成身分確認。",
    responsibleRole: "目前使用者",
    returnRoute: "accessUnavailable",
    recoveryRoute: "accountAccess",
    payloadPolicy: "ZERO_CASE_DATA",
  }),
  MEMBERSHIP_UNCONFIRMED: closedState({
    code: "MEMBERSHIP_UNCONFIRMED",
    reason: "目前無法確認你是否為這個案件的成員。",
    nextAction: "確認登入帳號與案件邀請是否一致。",
    responsibleRole: "目前使用者",
    returnRoute: "accessUnavailable",
    recoveryRoute: "accountAccess",
    payloadPolicy: "ZERO_CASE_DATA",
  }),
  ACCESS_UNCONFIRMED: closedState({
    code: "ACCESS_UNCONFIRMED",
    reason: "目前無法確認你是否能查看這個案件。",
    nextAction: "安全返回，再由案件邀請或已確認入口重新進入。",
    responsibleRole: "目前使用者",
    returnRoute: "accessUnavailable",
    recoveryRoute: "accessUnavailable",
    payloadPolicy: "ZERO_CASE_DATA",
  }),
  SUPPLEMENT_OVERDUE: closedState({
    code: "SUPPLEMENT_OVERDUE",
    reason: "待補文件已超過原訂處理時間。",
    nextAction:
      "查看待補內容與責任人；需要確認處理時間時，請聯絡待補責任人或返回原工作台。",
    responsibleRole: "待補項目責任人",
    returnRoute: "ownerWorkspace",
    recoveryRoute: "ownerWorkspace",
    payloadPolicy: "PRESERVE_EXISTING_CASE_READ_ONLY",
  }),
  CASE_CANCELLED: closedState({
    code: "CASE_CANCELLED",
    reason: "案件已取消，目前不再接受新的處理動作。",
    nextAction: "依已確認角色返回原工作台，查看取消依據與既有紀錄。",
  ...
  PCM_EXITED_BILATERAL_CONTINUATION: bilateralContinuationState({
    code: "PCM_EXITED_BILATERAL_CONTINUATION",
    reason:
      "PCM 已退出服務；甲乙雙方仍在原工作台延續文件、協商、排程、驗收、變更、附約與案件紀錄。",
    nextAction:
      "依已確認角色返回原工作台繼續案件；新的 PCM 審查與補件要求已停止。",
    responsibleRole: "甲方與乙方",
    returnRoute: "accessUnavailable",
    recoveryRoute: "accessUnavailable",
  }),
  CASE_CLOSED_READ_ONLY: closedState({
    ...
    reason: "案件已結案，原工作台保留完整內容供三方查閱。",
    nextAction: "依已確認角色返回原工作台，查看結案依據、三方確認與既有紀錄。",
    responsibleRole: "案件三方",
    returnRoute: "accessUnavailable",
    recoveryRoute: "accessUnavailable",
    payloadPolicy: "PRESERVE_EXISTING_CASE_READ_ONLY",

...
export const PCM_FLOW_CANONICAL_LINKS = Object.freeze([
  ...
  freezeRecord({
    ...
    canonicalHttpUrl: "http://127.0.0.1:4173/src/stitch_laibe_landing_onboarding/pcm_standalone/about_drs/code.html",
  ...
  freezeRecord({
    ...
    canonicalHttpUrl: "http://127.0.0.1:4173/src/stitch_laibe_landing_onboarding/pcm_standalone/quote_check/code.html?mode=quote#document-workspace",
  ...
  freezeRecord({
    ...
    canonicalHttpUrl: "http://127.0.0.1:4173/src/stitch_laibe_landing_onboarding/pcm_standalone/quote_check/code.html?mode=drawing#document-workspace",
    expectedVisibleState: "文件健檢工作台以圖說檢查模式載入，顯示施工圖文件入口、目前狀態與下一步。",
    returnRoute: "home",
    routeState: "active",
  }),
  freezeRecord({
    ...
    canonicalHttpUrl: "http://127.0.0.1:4173/src/stitch_laibe_landing_onboarding/pcm_standalone/quote_check/code.html?mode=contract#document-workspace",
  ...
  freezeRecord({
    ...
    canonicalHttpUrl: "http://127.0.0.1:4173/src/stitch_laibe_landing_onboarding/pcm_standalone/public_home/code.html#top",

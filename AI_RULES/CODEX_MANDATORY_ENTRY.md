...
4. AI_RULES/FILE_OWNERSHIP_RULES.md
5. AI_RULES/REVIEW_CHECKLIST.md
6. AI_RULES/HANDOFF_RULES.md
7. AI_RULES/TASK_DISPATCH_RULES.md
8. AI_RULES/LAIBE_BUILDER_RULES.md，若為 Builder / Codex 施工任務
9. AI_RULES/LAIBE_REVIEWER_RULES.md，若為 Reviewer 任務
10. NEXT_CODEX_HANDOFF.md，若存在
11. docs/NEXT_CODEX_HANDOFF.md，若存在且根目錄 handoff 不存在
